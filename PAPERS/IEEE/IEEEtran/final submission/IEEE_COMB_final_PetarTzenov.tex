...
\begin{IEEEkeywords}
	Quantum cascade lasers, nonlinear optics, terahertz radiation.
\end{IEEEkeywords}
...
\begin{figure}[h!]
	\centering
	\includegraphicsXS{IMGS/IEEE_COMB_figure1}
...
\begin{figure*}[tb]
\centering
 \includegraphicsL{IMGS/IEEE_COMB_figure2}
...
\begin{figure*}[tb]
	\centering
	\includegraphicsL{IMGS/IEEE_COMB_figure3}
...
\end{figure*}
	...
	\begin{figure}[h!]
		\centering
		\includegraphicsS{IMGS/IEEE_COMB_figure4}
	...
	\begin{figure}[h!]
		\centering
		\includegraphicsS{IMGS/IEEE_COMB_figure5}
	...
	\label{sec:basistransform}
	 ...
	 When $\hbar \epsilon \ll 1 $ meV, the close energetic alignment of the upper laser level and the injector state induces a strong wave function coupling, modelled via the energy interaction term $\hbar\Omega_{1'3}$ (typically $\approx1$ meV). This leads to a regime of coherent electron transport across the barrier via Rabi oscillations~\cite{callebaut2005importance}. In the absence of an electromagnetic field (i.e. $f=0$ in Eq.~(\ref{eq:hamiltonian-operatorform})) the total system's Hamiltonian is non-diagonal in the tight-binding basis, thus the inclusion of the coupling term $\hbar\Omega_{1'3}$ produces a splitting of the near-resonant states $\ket{1'}$ and $\ket{3}$ into a new doublet, the symmetric $\ket{-}$ and anti-symmetric $\ket{+}$ levels, energetically separated by $E_+-E_-\approx 2|\Omega_{1'3}|$ and spatially extending across the tunneling barrier (see Fig.~\ref{fig:biasdependence}). This splitting essentially results in a pair of upper levels, from both of which radiative transition to the ground state is possible.
	 	\begin{figure}[h!]
	 		\centering
	 		\includegraphicsS{IMGS/IEEE_COMB_figure6}
	...
	\begin{thebibliography}{10}
		...
		J.~Ye, \emph{Femtosecond optical frequency comb: principle, operation and
			applications}.\hskip 1em plus 0.5em minus 0.4em\relax Springer Science \&
		Business Media, 2005.
		
		\bibitem{schliesser2012mid}
		A.~Schliesser, N.~Picqu{\'e}, and T.~W. H{\"a}nsch, ``Mid-infrared frequency
		combs,'' \emph{Nat. Photon.}, vol.~6, no.~7, pp. 440--449, 2012.
		
		\bibitem{hugi2012mid}
		A.~Hugi, G.~Villares, S.~Blaser, H.~Liu, and J.~Faist, ``Mid-infrared frequency
		comb based on a quantum cascade laser,'' \emph{Nature}, vol. 492, no. 7428,
		pp. 229--233, 2012.
		
		\bibitem{burghoff2014terahertz}
		D.~Burghoff, T.-Y. Kao, N.~Han, C.~W.~I. Chan, X.~Cai, Y.~Yang, D.~J. Hayton,
		J.-R. Gao, J.~L. Reno, and Q.~Hu, ``Terahertz laser frequency combs,''
		\emph{Nat. Photon.}, vol.~8, no.~6, pp. 462--467, 2014.
		
		\bibitem{rosch2015octave}
		M.~R{\"o}sch, G.~Scalari, M.~Beck, and J.~Faist, ``Octave-spanning
		semiconductor laser,'' \emph{Nat. Photon.}, vol.~9, no.~1, pp. 42--47, 2015.
		
		\bibitem{villares2014dual}
		G.~Villares, A.~Hugi, S.~Blaser, and J.~Faist, ``Dual-comb spectroscopy based
		on quantum-cascade-laser frequency combs,'' \emph{Nat. Commun.}, vol.~5, p.
		5192, 2014.
		...
		\emph{Optica}, vol.~3, no.~5, pp. 499--502, 2016.
		
		\bibitem{Burghoff1601227}
		D.~Burghoff, Y.~Yang, and Q.~Hu, ``Computational multiheterodyne
		spectroscopy,'' \emph{Sci. Adv.}, vol.~2, no.~11, 2016.
		
		\bibitem{khurgin2014coherent}
		J.~Khurgin, Y.~Dikmelik, A.~Hugi, and J.~Faist, ``Coherent frequency combs
		produced by self frequency modulation in quantum cascade lasers,''
		\emph{Appl. Phys. Lett.}, vol. 104, no.~8, p. 081118, 2014.
		
		\bibitem{villares2015quantum}
		G.~Villares and J.~Faist, ``Quantum cascade laser combs: effects of modulation
		and dispersion,'' \emph{Opt. Express}, vol.~23, no.~2, pp. 1651--1669, 2015.
		
		\bibitem{petz2016}
		P.~Tzenov, D.~Burghoff, Q.~Hu, and C.~Jirauschek, ``Time domain modeling of
		terahertz quantum cascade lasers for frequency comb generation,'' \emph{Opt.
			Express}, vol.~24, no.~20, pp. 23\,232--23\,247, 2016.
		
		\bibitem{mansuripur2016}
		T.~S. Mansuripur, C.~Vernet, P.~Chevalier, G.~Aoust, B.~Schwarz, F.~Xie,
		C.~Caneau, K.~Lascola, C.-e. Zah, D.~P. Caffey, T.~Day, L.~J. Missaggia,
		M.~K. Connors, C.~A. Wang, A.~Belyanin, and F.~Capasso, ``Single-mode
		instability in standing-wave lasers: The quantum cascade laser as a
		self-pumped parametric oscillator,'' \emph{Phys. Rev. A}, vol.~94, p. 063807,
		2016.
		
		\bibitem{williams2007terahertz}
		B.~S. Williams, ``Terahertz quantum-cascade lasers,'' \emph{Nat. Photon.},
		vol.~1, no.~9, pp. 517--525, 2007.
		
		\bibitem{wang2015generating}
		F.~Wang, K.~Maussang, S.~Moumdji, R.~Colombelli, J.~R. Freeman, I.~Kundu,
		L.~Li, E.~H. Linfield, A.~G. Davies, J.~Mangeney \emph{et~al.}, ``Generating
		ultrafast pulses of light from quantum cascade lasers,'' \emph{Optica},
		vol.~2, no.~11, pp. 944--949, 2015.
		
		\bibitem{jirauschek2014modeling}
		C.~Jirauschek and T.~Kubis, ``Modeling techniques for quantum cascade lasers,''
		\emph{Appl. Phys. Rev.}, vol.~1, no.~1, p. 011307, 2014.
		
		\bibitem{indjin2003mechanisms}
		D.~Indjin, P.~Harrison, R.~Kelsall, and Z.~Ikoni{\'c}, ``Mechanisms of
		temperature performance degradation in terahertz quantum-cascade lasers,''
		\emph{Appl. Phys. Lett.}, vol.~82, no.~9, pp. 1347--1349, 2003.
		
		\bibitem{yang2010rate}
		Q.~Yang, B.~Hinkov, F.~Fuchs, W.~Bronner, K.~K{\"o}hler, J.~Wagner, R.~Maulini,
		and J.~Faist, ``Rate equations analysis of external-cavity quantum cascade
		lasers,'' \emph{J. Appl. Phys.}, vol. 107, no.~4, p. 043109, 2010.
		
		\bibitem{iotti2001}
		R.~C. {Iotti} and F.~{Rossi}, ``{Nature of charge transport in quantum-cascade
			lasers},'' \emph{Phys. Rev. Lett.}, vol.~87, no.~14, p. 146603, 2001.
		
		\bibitem{weber2009}
		C.~{Weber}, A.~{Wacker}, and A.~{Knorr}, ``{Density-matrix theory of the
			optical dynamics and transport in quantum cascade structures: The role of
			coherence},'' \emph{Phys. Rev. B}, vol.~79, no.~16, p. 165322, 2009.
		
		\bibitem{talukder2010self}
		M.~A. Talukder and C.~R. Menyuk, ``Self-induced transparency modelocking of
		quantum cascade lasers in the presence of saturable nonlinearity and group
		velocity dispersion,'' \emph{Opt. Express}, vol.~18, no.~6, pp. 5639--5653,
		2010.
		
		\bibitem{wang2015active}
		Y.~Wang and A.~Belyanin, ``Active mode-locking of mid-infrared quantum cascade
		lasers with short gain recovery time,'' \emph{Opt. Express}, vol.~23, no.~4,
		pp. 4173--4185, 2015.
		
		\bibitem{terazzi2010density}
		R.~Terazzi and J.~Faist, ``A density matrix model of transport and radiation in
		quantum cascade lasers,'' \emph{New J. Phys.}, vol.~12, no.~3, p. 033045,
		2010.
		
		\bibitem{iotti2000hotcarrier}
		R.~C. {Iotti} and F.~{Rossi}, ``{Microscopic theory of hot-carrier relaxation
			in semiconductor-based quantum-cascade lasers},'' \emph{Appl. Phys. Lett.},
		vol.~76, p. 2265, 2000.
		
		\bibitem{callebaut2004montecarlo}
		H.~{Callebaut}, S.~{Kumar}, B.~S. {Williams}, Q.~{Hu}, and J.~L. {Reno},
		``{Importance of electron-impurity scattering for electron transport in
			terahertz quantum-cascade lasers},'' \emph{Appl. Phys. Lett.}, vol.~84, pp.
		645--647, 2004.
		
		\bibitem{jirauschek2009monte}
		C.~Jirauschek and P.~Lugli, ``{Monte-Carlo-based spectral gain analysis for
			terahertz quantum cascade lasers},'' \emph{J. Appl. Phys.}, vol. 105, no.~12,
		p. 123102, 2009.
		
		\bibitem{shi2014nonequilibrium}
		Y.~Shi and I.~Knezevic, ``Nonequilibrium phonon effects in midinfrared quantum
		cascade lasers,'' \emph{J. Appl. Phys.}, vol. 116, no.~12, p. 123105, 2014.
		
		\bibitem{wacker2002gain}
		A.~{Wacker}, ``{Gain in quantum cascade lasers and superlattices: A quantum
			transport theory},'' \emph{Phys. Rev. B}, vol.~66, no.~8, p. 085326, 2002.
		
		\bibitem{kubis2009theory}
		T.~{Kubis}, C.~{Yeh}, P.~{Vogl}, A.~{Benz}, G.~{Fasching}, and C.~{Deutsch},
		``{Theory of nonequilibrium quantum transport and energy dissipation in
			terahertz quantum cascade lasers},'' \emph{Phys. Rev. B}, vol.~79, no.~19, p.
		195323, 2009.
		
		\bibitem{wacker2013nonequilibrium}
		A.~{Wacker}, M.~{Lindskog}, and D.~O. {Winge}, ``Nonequilibrium {G}reen's
		function model for simulation of quantum cascade laser devices under
		operating conditions,'' \emph{IEEE J. Sel. Top. Quantum Electron.}, vol.~19,
		no.~5, pp. 1--11, 2013.
		
		\bibitem{callebaut2005importance}
		H.~Callebaut and Q.~Hu, ``Importance of coherence for electron transport in
		terahertz quantum cascade lasers,'' \emph{J. Appl. Phys.}, vol.~98, no.~10,
		p. 104505, 2005.
		
		\bibitem{kumar2009coherence}
		S.~Kumar and Q.~Hu, ``Coherence of resonant-tunneling transport in terahertz
		quantum-cascade lasers,'' \emph{Phys. Rev. B}, vol.~80, no.~24, p. 245316,
		2009.
		
		\bibitem{dupont2010simplified}
		E.~Dupont, S.~Fathololoumi, and H.~Liu, ``Simplified density-matrix model
		applied to three-well terahertz quantum cascade lasers,'' \emph{Phys. Rev.
			B}, vol.~81, no.~20, p. 205311, 2010.
		...
		\emph{Phys. Rev A}, vol.~75, p. 031802, Mar 2007.
		
		\bibitem{burghoff2015evaluating}
		D.~Burghoff, Y.~Yang, D.~J. Hayton, J.-R. Gao, J.~L. Reno, and Q.~Hu,
		``Evaluating the coherence and time-domain profile of quantum cascade laser
		frequency combs,'' \emph{Opt. Express}, vol.~23, no.~2, pp. 1190--1202, 2015.
		
		\bibitem{bastard1990wave}
		G.~Bastard, \emph{{Wave Mechanics Applied to Semiconductor
				Heterostructures}}.\hskip 1em plus 0.5em minus 0.4em\relax New York, NY
		(USA); John Wiley and Sons Inc., 1990.
		
		\bibitem{boyd2003nonlinear}
		R.~W. Boyd, \emph{Nonlinear {O}ptics}.\hskip 1em plus 0.5em minus 0.4em\relax
		Academic {P}ress, 2003.
		
		\bibitem{iotti2005microscopic}
		R.~C. Iotti and F.~Rossi, ``Microscopic theory of semiconductor-based
		optoelectronic devices,'' \emph{Rep. Prog. Phys.}, vol.~68, no.~11, p. 2533,
		2005.
		
		\bibitem{jirauschek2010monte}
		C.~Jirauschek, ``{Monte Carlo study of intrinsic linewidths in terahertz
			quantum cascade lasers},'' \emph{Opt. Express}, vol.~18, no.~25, pp.
		25\,922--25\,927, 2010.
		...
		J.~Faist, and F.~Capasso, ``Multimode regimes in quantum cascade lasers: From
		coherent instabilities to spatial hole burning,'' \emph{Phys. Rev. A},
		vol.~77, p. 053804, May 2008.
		
		\bibitem{friedli2013four}
		P.~Friedli, H.~Sigg, B.~Hinkov, A.~Hugi, S.~Riedi, M.~Beck, and J.~Faist,
		``Four-wave mixing in a quantum cascade laser amplifier,'' \emph{Appl. Phys.
			Lett.}, vol. 102, no.~22, p. 222104, 2013.
		
		\bibitem{risken1968self}
		H.~Risken and K.~Nummedal, ``Self-pulsing in lasers,'' \emph{J. Appl. Phys.},
		vol.~39, no.~10, pp. 4662--4672, 1968.
		
		\bibitem{graham1968quantum}
		R.~Graham and H.~Haken, ``Quantum theory of light propagation in a fluctuating
		laser-active medium,'' \emph{Z. Phys.}, vol. 213, no.~5, pp. 420--450, 1968.
		
		\bibitem{villares2016dispersion}
		G.~Villares, S.~Riedi, J.~Wolf, D.~Kazakov, M.~J. S{\"u}ess, P.~Jouy, M.~Beck,
		and J.~Faist, ``Dispersion engineering of quantum cascade laser frequency
		combs,'' \emph{Optica}, vol.~3, no.~3, pp. 252--258, 2016.
		
		\bibitem{sutherland2003handbook}
		R.~L. Sutherland, \emph{{Handbook of Nonlinear Optics}}.\hskip 1em plus 0.5em
		minus 0.4em\relax CRC press, 2003.
		
		\bibitem{gkortsas2010dynamics}
		V.-M. Gkortsas, C.~Wang, L.~Kuznetsova, L.~Diehl, A.~Gordon, C.~Jirauschek,
		M.~Belkin, A.~Belyanin, F.~Capasso, and F.~K{\"a}rtner, ``Dynamics of
		actively mode-locked quantum cascade lasers,'' \emph{Opt. Express}, vol.~18,
		no.~13, pp. 13\,616--13\,630, 2010.
		
		\bibitem{siegman1986lasers}
		A.~E. Siegman, \emph{Lasers}.\hskip 1em plus 0.5em minus 0.4em\relax
		{University Science Books, Mill Valley, CA}, 1986.
		
		\bibitem{taflove2000computational}
		A.~Taflove and S.~C. Hagness, \emph{{Computational Electrodynamics}}.\hskip 1em
		plus 0.5em minus 0.4em\relax Artech house publishers, 2000.
		
		\bibitem{herr2012universal}
		T.~Herr, K.~Hartinger, J.~Riemensberger, C.~Wang, E.~Gavartin, R.~Holzwarth,
		M.~Gorodetsky, and T.~Kippenberg, ``Universal formation dynamics and noise of
		kerr-frequency combs in microresonators,'' \emph{Nat. Photon.}, vol.~6,
		no.~7, pp. 480--487, 2012.
		
		\bibitem{toll1956}
		J.~S. Toll, ``Causality and the dispersion relation: Logical foundations,''
		\emph{Phys. Rev.}, vol. 104, pp. 1760--1770, 1956.
		
		\bibitem{revin2016active}
		D.~Revin, M.~Hemingway, Y.~Wang, J.~Cockburn, and A.~Belyanin, ``Active mode
		locking of quantum cascade lasers in an external ring cavity,'' \emph{Nat.
			Commun.}, vol.~7, 2016.
		
	\end{thebibliography}
	\begin{IEEEbiography}
		[{\includegraphicsBIO{IMGS/IEEE_COMB_photo1}}]{Petar Tzenov} received his B.S. degree in applied mathematics from Sofia University (St. "Kliment Ohrisdski"), Bulgaria, in 2012. From 2012 to 2014 he completed a M.S. degree in computational science and engineering at the Technische Universit\"at M\"unchen (TUM), Germany. Since 2015 he has been a member of Dr. Jirauschek's group in computational photonics at the TUM, pursuing his Ph.D. degree in the areas of laser physics and nonlinear optics. 
	...
	\end{IEEEbiography}
	\begin{IEEEbiography}
		[{\includegraphicsBIO{IMGS/IEEE_COMB_photo3}}]{Qing Hu} (M'03-SM'03-F'10) received the Ph.D. degree in physics from Harvard University, Cambridge, MA, USA, in 1987.

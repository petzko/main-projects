...
%%
%%   See the REVTeXftze 4.1 README file for restrictions and more information.
%%
...
\usepackage{xr}
\externaldocument[SUPPL-]{THB_FINAL_supplementary}
...
\newcommand{\includegraphicsM}[1]{\includegraphics[width = 0.30\textwidth]{#1}}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width = 0.45\textwidth]{IMGS/quasi-bloch-resonance-new2.eps}
